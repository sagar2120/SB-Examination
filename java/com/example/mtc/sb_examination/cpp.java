...
public class cpp extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb1 =(RadioButton) findViewById(R.id.button13);
        rb2 =(RadioButton) findViewById(R.id.button14);
        rb3 =(RadioButton) findViewById(R.id.button15);
        rb4 =(RadioButton) findViewById(R.id.button16);
        ...
        if (savedInstanceState == null) {
            ...
            questionList = (ArrayList<Question>) dbHelper.getAllQuestions("cpp");
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()|| rb4.isChecked()) {
                        ...
                        Toast.makeText(cpp.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
