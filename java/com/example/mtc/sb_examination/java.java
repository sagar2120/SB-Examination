...
public class java extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb1 =(RadioButton) findViewById(R.id.button9);
        rb2 =(RadioButton) findViewById(R.id.button10);
        rb3 =(RadioButton) findViewById(R.id.button11);
        rb4 =(RadioButton) findViewById(R.id.button12);
        ...
        if (savedInstanceState == null) {
            ...
            questionList = (ArrayList<Question>) dbHelper.getAllQuestions("java");
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()|| rb4.isChecked()) {
                        ...
                        Toast.makeText(java.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
