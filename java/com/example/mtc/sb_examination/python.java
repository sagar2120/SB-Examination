...
public class python extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb1 =(RadioButton) findViewById(R.id.button5);
        rb2 =(RadioButton) findViewById(R.id.button6);
        rb3 =(RadioButton) findViewById(R.id.button7);
        rb4 =(RadioButton) findViewById(R.id.button8);
        ...
        if (savedInstanceState == null) {
            ...
            questionList = (ArrayList<Question>) dbHelper.getAllQuestions("python");
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (rb1.isChecked() || rb2.isChecked() || rb3.isChecked()|| rb4.isChecked()) {
                        ...
                        Toast.makeText(python.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    showNextQuestion();
                }
    ...
    private void finishQuiz() {
        ...
        Intent i1=new Intent(this,activity_result.class);
        i1.putExtra("marks",String.valueOf(score));
